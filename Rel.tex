...
\begin{aligned}
  ...
  \llbracket t_0 \times t_1 \rrbracket_v & =\llbracket t_0 \rrbracket \times \llbracket t_1 \rrbracket \\
  ...
  \llbracket E_0 \, E_1 \rrbracket(s_0) & = \exists s_1,  \llbracket E_1 \rrbracket (s_1) \wedge \llbracket E_0 \rrbracket (s_1, s_0)\\
  \llbracket \forall (x \colon t). E_0 \rrbracket(s_0, s_1) & = \forall E_1, \llbracket E_1 \rrbracket = s_0 \rightarrow \llbracket [x \update E_1] E_0 \rrbracket (s_1) 
\end{aligned}
\]
