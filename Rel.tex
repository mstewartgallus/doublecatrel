...
\[\begin{aligned}
&\textbf{Types} &  t & \bnfdef \prop \mid \unit \mid t \times t  \\
&\textbf{Contexts}  & E & \bnfdef x_t \mid \success \mid E \pass E \mid E \, E \mid \forall (x \colon t) . E  \\
&\textbf{Terms} &  v & \bnfdef x \mid \coin \mid \fst(v) \mid \snd(v) \mid v , v  \\
